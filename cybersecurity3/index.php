...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white" style="background-image: url('../../Image/cybercover.png');">
  ...
  <div class="w3-display-middle">
    ...
    <div class="subrow" style="margin-top: 5%;">
      <div class="subcolumn">
        <a href="https://cyber.code-rmit.edu.vn/cybersecurity3/eng/login.php" target="_blank"><img class="imgheader" src="../../Image/engchoose.png" style="width: 100%; "></img></a>
      </div>
      <div class="subcolumn">
        <a href="https://cyber.code-rmit.edu.vn/cybersecurity3/vn/login.php" target="_blank"><img class="imgheader" src="../../Image/vnchoose.png" style="width: 100%; "></img></a>
      </div>
    </div>
  </div>
