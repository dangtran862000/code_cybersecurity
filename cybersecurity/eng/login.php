  ...
  <div class="login-root">
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        ...
        <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">  
          <h1><a href="" style="color: #222160" rel="dofollow">CYBER SECURITY WORKSHOP</a></h1>
        </div>
          <div class="formbg" style="margin-top: 5%; margin-bottom:5%">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form id="stripe-login" action="login_submit.php" method="POST">
                ...
                <div class="field padding-bottom--24">
                <button style="background-color: #FAC800; color: #222160" class="loginbutton" type="submit" name="submit">LOGIN</button>
                </div>
