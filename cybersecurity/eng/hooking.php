...
<?php 
    ...
    if ($title_page == 1) {
        ...
        $sql = "SELECT * FROM user WHERE email='$title_page'";
...
<img class="noti responsive" src="../../Image/EngMicrosoftTeams-image.png" style="float: right; margin-right: 50px; margin-top:50px">
<div class="error">
