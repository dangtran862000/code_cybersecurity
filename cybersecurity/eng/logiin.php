  ...
  <div class="login-root">
      <div class="box-root flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        ...
        <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">  
          <h1><a href="" style="color: #222160" rel="dofollow">CYBeR SECUR!TY WoRKSH0P</a></h1>
        </div>
          <div class="formbg" style="margin-top: 5%; margin-bottom:5%">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <?php
                ...
                $result = $conn->query($sql);
                    ...
                    if(isset($_SESSION["thongbao"])) {
                        if ($_SESSION["thongbao"] == "Registered sussesfully, please login to your account!") {
              ...
              <form id="stripe-login" action="logiin_submit.php" method="POST">
                ...
                <div class="field padding-bottom--24">
                <button style="background-color: #e60028; color: #fac800" class="loginbutton" type="submit" name="submit">LOG IN</button>
                </div>
                <!--<span style="color: black; font-size: 15px">Don't have an account? <a href="index.php" style="color: #fac800; font-size: 15px">Register</a></span>-->
              </form>
            </div>
          </div>
        </div>
