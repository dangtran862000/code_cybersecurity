...
<img class="imgheader_responsive" src="../../Image/Iconcombine - original.png" ></img>
  ...
  <a href="phishinggetstarted.php">DETECTING PHISHING</a>
    <a  class="active" href="cyberiskgetstarted.php">CYBERISK</a>
    ...
    <div style="padding-top: 0.5%; padding-bottom:10%; min-height: 80%">
      <div class="colresponsive">
        ...
        <img src="../../Image/eng/cyberiskeng.png" style="width: 100%; float: center; margin-top:0.5%" onContextMenu="return false;"></img>
        <div style="margin-top: 3%; margin-left: 15%; margin-right:15%">  
        <div class="subrow" style="margin-top: 3%">
          <div class="subcolumn">
            <h2 style="margin-top: 5%; margin-right:10%; font-family:arial; color:  #222160;">RULES:</h2>
            <h4> <li style="margin-top: 5%; margin-right:10%; font-family:arial; color:  #222160;">You need to help Aya (an undergrad student) make digital security decisions throughout her day.</li> </h4>
            <h4> <li style="margin-top: 5%; margin-right:10%; font-family:arial; color:  #222160;">Click anywhere to advance the story and choose an option.</li> </h4>
            <h4> <li style="margin-top: 5%; margin-right:10%; font-family:arial; color:  #222160;">Try to win maximum credits.</li> </h4>
          </div>
          <div class="subcolumn">
          <h2 style="margin-top: 5%; margin-right:10%; font-family:arial; color:  #E61E2A;">NOTE: </h2>
            <h4> <li style="margin-top: 5%; margin-right:10%; font-family:arial; color:  #E61E2A;">This activity is for educational purposes only. RMIT Vietnam University will not save any player information.</li> </h4>
          </div>
        </div>
        <div style="margin-top: 8%; margin-left: 0%; margin-right:0%">
            <h2 style="margin-top: 5%; margin-bottom: 5%; margin-right:10%; font-family:arial; color:  #222160;">HOW-TO-PLAY VIDEO: </h2>     
        <div class="containerwordwall"> 
            <video class="responsive-iframewordwall" src="../../Image/eng/video 02.mp4" autoplay loop muted frameborder="0" allowfullscreen onContextMenu="return false;"></video>
        </div>
        ...
        <form id="stripe-login" action="cyberisk.php" onclick="myFunction()">
                ...
                <button class="loginbutton" type = "submit" style="color: black; background-color: #FAC800; padding: 15px 100px">CLICK TO START</button>
                </div>
              </form>
