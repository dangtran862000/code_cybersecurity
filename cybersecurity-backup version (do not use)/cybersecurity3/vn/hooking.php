...
<script type="text/javascript">
    window.onload = function () {
        setTimeout(function () {
            //DownloadFile("This_is_malware.txt");
        }, 1000);
    };
...
<?php 
    session_start();
    include 'config.php';
    $title_page = isset($_GET['email']) ? $_GET['email'] : 1;
    if ($title_page == 1) {
    }
        $sql = "SELECT * FROM user_vn WHERE email='$title_page'";
...
<img class="noti responsive" src="../../Image/MicrosoftTeams-image.png" style="float: right; margin-right: 50px; margin-top:50px">
<div class="error">
    <a href="download.html"> Download Link </a> 
<div class="wrap">
  <div class="404">
    <pre><code>
