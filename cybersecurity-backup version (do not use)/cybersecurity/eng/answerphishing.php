        ...
        <div style="margin-top: 2%; margin-left: 15%; margin-right:15%">
            ...
            <?php if ($answer == TRUE) { ?>
              ...
              <div class="subrow">
                ...
                <h4  style="margin-top: 5%; text-align: center; float: center;color: green;"><image src="../../Image/eng/Authentic content.png" width="600" frameBorder="0" allowFullScreen></image></h4>
        ...
        <!-- lựa chọn xem hình và phóng to hình -->
            <?php if ($answer == FALSE) { ?>
              ...
              <script>
                ...
                <h4 style="margin-bottom: 0%; text-align: center; float: center;color: #E61E2A;"><image  src="../../Image/eng/Phishing content.png" width="600"frameBorder="0" allowFullScreen></image></h4>
                    ...
                    <div id="myNav1" class="overlay" >
                        ...
                        <button class="closebtn" style="float: right; margin-top:30%: margin-right:30%; font-size: 30px; background-color: #FAC800;" onclick="closeNav('myNav1')">&nbsp; <strong>X<strong> &nbsp;</button>
                            <div class="overlay-content">
                                ...
                                <img class="responsive" src="../../Image/eng/phishingsrc/answer/<?php echo $title_page; ?>.png" alt="phishing">
