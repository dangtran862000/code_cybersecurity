    ...
    ?>CLICK THE BUTTON TO TURN ON/OFF THE SOUND</h5>
          ...
          for ($x = 0; $x < 5 ; $x++) {
            ?> <span style="font-size:30px; cursor:pointer; " onclick="openNav('myNav<?php echo $x; ?>')">
                    ...
                    <img class="mySlides" src="../../Image/eng/phishingsrc/<?php echo $array_questions[$x]; ?>.jpg" style="width:100%; border: 5px solid #222160;" onContextMenu="return false;">
                    </img>
                </span> 
            <?php } ?>
            ...
            <div class="subrow">
                ...
                <h4  style=" margin-top: 5%; margin-bottom: 0%; text-align: center; float: center;color: red;"><image style="margin-bottom: 0%; text-align: center; float: center;" src="../../Image/eng/Out of time.png" width="600" frameBorder="0" allowFullScreen onContextMenu="return false;"></image></h4>
                    ...
                    <div id="myNav<?php echo $x; ?>" class="overlay" >
                        ...
                        <button class="closebtn" style="float: right; margin-top:30%: margin-right:30%; font-size: 30px; background-color: #fac800;" onclick="closeNav('myNav<?php echo $x; ?>')">&nbsp; X &nbsp;</button>
                            <div class="overlay-content">
                                ...
                                <img class="responsive" src="../../Image/eng/phishingsrc/<?php echo $array_questions[$x]; ?>.jpg" alt="phishing" onContextMenu="return false;">
