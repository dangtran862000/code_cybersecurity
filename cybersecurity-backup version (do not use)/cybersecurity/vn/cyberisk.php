...
.subrow:after {
  ...
  clear: both;
    ...
    <?php 
        ...
        $status = $wordwall['cyberattackstatus'];
 ...
 <a style="padding: 30px 50px" href="phishinggetstarted.php">TRUY TÌM SỰ THẬT</a>
    ...
    <div class="colresponsive" style=" padding-top: 0.5%; padding-bottom:0%; min-height: 80%">
      <div >
        ...
        <div class="containerwordwall" style="margin-bottom: 0%"> 
            <!--<iframe class="responsive-iframewordwall" src="https://itch.io/embed-upload/5836933?color=222160"  frameborder="0" allowfullscreen></iframe>-->
            <!--<iframe class="responsive-iframewordwall" frameborder="0" src="https://itch.io/embed-upload/5911372?color=222160" allowfullscreen></iframe>-->
            <!--<iframe class="responsive-iframewordwall" frameborder="0" src="https://itch.io/embed-upload/6068054?color=222160" allowfullscreen></iframe>-->
            <iframe class="responsive-iframewordwall" frameborder="0" src="https://itch.io/embed-upload/6089468?color=222160" allowfullscreen></iframe>
        </div>
            <?php
            } else {
                ?> 
                ...
                <div>
                    ...
                    <h3 style="text-align: center; float: center; margin-top: 10%; margin-left: 10%; margin-right:10%; font-family:arial; font-size: 30px;" class = "center">TRÒ CHƠI TẤN CÔNG MẠNG CHƯA ĐƯỢC BẮT ĐẦU</h3>
