  ...
  <div class="header-right">
   <a  style="padding: 30px 50px" href="phishinggetstarted.php">TRUY TÌM SỰ THẬT</a>
    ...
    <div  style=" padding-top: 0.5%; padding-bottom:10%; min-height:80%;">
        ...
        <img src="../../Image/vn/password.jpg" style="width: 100%; float: center; margin-top:0.5%" onContextMenu="return false;"></img>
        ...
        <div class="containerwordwall"> 
            <video class="responsive-iframewordwall" src="../../Image/vn/video password vie.mp4" autoplay loop frameborder="0" allowfullscreen onContextMenu="return false;"></video>
        </div>
